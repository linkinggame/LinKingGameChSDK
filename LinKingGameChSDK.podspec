...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/leon/LinKingGameChSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'leon' => 'dml630@163.com' }
  s.source           = { :git => 'https://github.com/leon/LinKingGameChSDK.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'LinKingGameChSDK' => ['LinKingGameChSDK/Assets/*.png']
  # }
