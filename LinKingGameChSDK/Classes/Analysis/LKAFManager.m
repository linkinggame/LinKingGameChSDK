...
#import "LKLog.h"
@interface LKAFManager ()<AppsFlyerLibDelegate>
...
static LKAFManager *_instance = nil;

@implementation LKAFManager

+ (instancetype)shared{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _instance = [[LKAFManager alloc] init];
...
- (void)registAppsFlyer{
    ...
    if (sdkConfig != nil) {
        ...
        NSString *appleAppID = af[@"apple_appid_ios"];
        [AppsFlyerLib shared].appsFlyerDevKey =  appsflyer_key_ios;
        [AppsFlyerLib shared].appleAppID =appleAppID;
        [AppsFlyerLib shared].delegate = self;
          /* Set isDebug to true to see AppsFlyer debug logs */
//        [AppsFlyerLib shared].isDebug = self.isDebug;
