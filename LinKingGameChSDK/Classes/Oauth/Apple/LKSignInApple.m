...
@interface LKSignInApple ()<ASAuthorizationControllerDelegate,ASAuthorizationControllerPresentationContextProviding>

@end
static LKSignInApple *_instance;
@implementation LKSignInApple
+ (instancetype)instance{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _instance = [[LKSignInApple alloc] init];
...
//               LKLogInfo(@"=====================");
            //  需要使用钥匙串的方式保存用户的唯一信息
            [LKHandleKeychain save:KEYCHAIN_IDENTIFIER(@"SignInWithApple") data:user];
