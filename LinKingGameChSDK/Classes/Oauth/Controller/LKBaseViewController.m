...
//            if (self.width > [UIScreen mainScreen].bounds.size.width * 0.6) {
//                self.width = 300;
//            }
//
//            if (self.height > [UIScreen mainScreen].bounds.size.height) {
//                constant = 20;
//            }else{
//                constant = ([UIScreen mainScreen].bounds.size.height - self.height) * 0.5;
//            }
//        }
//
//        constraint3 = [NSLayoutConstraint constraintWithItem:self.contentView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeTop multiplier:1.0 constant:constant];
//        constraint4 = [NSLayoutConstraint constraintWithItem:self.contentView attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeBottom multiplier:1.0 constant:-constant];
//
//        constraint5 = [NSLayoutConstraint constraintWithItem:self.contentView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeWidth multiplier:0 constant:self.width];
//
//    }else{
//
//
...
//                 constant = 20;
//             }else{
//                 constant = ([UIScreen mainScreen].bounds.size.width - self.width) * 0.5;
//             }
//
//        }
//        constraint3 = [NSLayoutConstraint constraintWithItem:self.contentView attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeLeft multiplier:1.0 constant:constant];
...
//        constraint4 = [NSLayoutConstraint constraintWithItem:self.contentView attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeRight multiplier:1.0 constant:-constant];
//
//        constraint5 = [NSLayoutConstraint constraintWithItem:self.contentView attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1 constant:self.height];
//    }
//
//    self.constraints = [NSArray arrayWithObjects:constraint1, constraint2, constraint3, constraint4,constraint5 ,nil];
//
